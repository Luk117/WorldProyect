...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 90, 921, 641))
        ...
        self.bt_buscarTodosp = QtWidgets.QPushButton(self.tabPais)
        self.bt_buscarTodosp.setGeometry(QtCore.QRect(620, 70, 111, 41))
        self.bt_buscarTodosp.setObjectName("bt_buscarTodosp")
        self.tabWidget.addTab(self.tabPais, "")
        self.tabLenguaje = QtWidgets.QWidget()
        self.tabLenguaje.setObjectName("tabLenguaje")
        self.tableWidget = QtWidgets.QTableWidget(self.tabLenguaje)
        self.tableWidget.setGeometry(QtCore.QRect(390, 100, 401, 361))
        ...
        self.lineEdit = QtWidgets.QLineEdit(self.tabLenguaje)
        ...
        self.bt_refreshlengua = QtWidgets.QPushButton(self.tabLenguaje)
        self.bt_refreshlengua.setGeometry(QtCore.QRect(694, 480, 91, 41))
        self.bt_refreshlengua.setObjectName("bt_refreshlengua")
        self.bt_buscarTodosc = QtWidgets.QPushButton(self.tabLenguaje)
        self.bt_buscarTodosc.setGeometry(QtCore.QRect(580, 480, 111, 41))
        self.bt_buscarTodosc.setObjectName("bt_buscarTodosc")
        self.tabWidget.addTab(self.tabLenguaje, "")
        self.tabCiudad = QtWidgets.QWidget()
        self.tabCiudad.setObjectName("tabCiudad")
        self.tableWidget_2 = QtWidgets.QTableWidget(self.tabCiudad)
        self.tableWidget_2.setGeometry(QtCore.QRect(340, 80, 501, 441))
        ...
        self.bt_refreshciudades = QtWidgets.QPushButton(self.tabCiudad)
        self.bt_refreshciudades.setGeometry(QtCore.QRect(760, 530, 75, 41))
        self.bt_refreshciudades.setObjectName("bt_refreshciudades")
        self.bt_buscarTodosl = QtWidgets.QPushButton(self.tabCiudad)
        self.bt_buscarTodosl.setGeometry(QtCore.QRect(640, 530, 111, 41))
        self.bt_buscarTodosl.setObjectName("bt_buscarTodosl")
        self.tabWidget.addTab(self.tabCiudad, "")
        ...
        self.tabWidget.addTab(self.agregarCampo, "")
        ...
        self.tabWidget.addTab(self.eliminarCampo, "")
        ...
        self.tabWidget.addTab(self.actualizarPais, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_refreshpais.setText(_translate("MainWindow", "Actualizar"))
        self.label.setText(_translate("MainWindow", "Codigo:"))
        self.bt_buscarpais.setText(_translate("MainWindow", "Buscar"))
        self.bt_buscarTodosp.setText(_translate("MainWindow", "Buscar Todos"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabPais), _translate("MainWindow", "Consultar Pais"))
        ...
        self.bt_refreshlengua.setText(_translate("MainWindow", "Actualizar"))
        self.bt_buscarTodosc.setText(_translate("MainWindow", "Buscar Todos"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabLenguaje), _translate("MainWindow", "Consultar Lenguaje"))
        ...
        self.bt_refreshciudades.setText(_translate("MainWindow", "Actualizar"))
        self.bt_buscarTodosl.setText(_translate("MainWindow", "Buscar Todos"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabCiudad), _translate("MainWindow", "Consultar Ciudad"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.agregarCampo), _translate("MainWindow", "Agregar Campo"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.eliminarCampo), _translate("MainWindow", "Eliminar Campo"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.actualizarPais), _translate("MainWindow", "Actualizar Pais"))
